<html><!--Jared Dylan Simons L38876914-->
  ...
  <body> <!--Navbar with tabs that link to each page-->
    ...
    <!--Html code for creating input form for Parent Info-->
    ...
    if (isset($_POST['submit'])) {
      ...
      //SQL statement 'INSERT INTO' inserts data from fields into corosponding table rows in 'parents table
      $sql = "INSERT INTO parent (fname,lname,contact,email,address) VALUES ('$fname','$lname','$contact','$email','$address')";
